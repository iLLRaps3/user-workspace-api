...
import { insertUserSchema, creditTransactionSchema, insertChatSchema, updateChatSchema } from "../shared/schema.js";
    ...
    try {
      ...
      const chat = await storage.createChat({
        ...
        messages: Array.isArray(chatData.messages) 
          ? (chatData.messages as Array<{ role: string; content: string; timestamp: string | number | Date }>).map((msg) => ({
